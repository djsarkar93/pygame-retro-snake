...
class Snake:
    def __init__(self):
        ...
        self.eat_sound = pygame.mixer.Sound(os.path.join(os.getcwd(), 'sounds', 'eat.mp3'))
        self.wall_hit_sound = pygame.mixer.Sound(os.path.join(os.getcwd(), 'sounds', 'wall.mp3'))
...
if __name__ == '__main__':
    ...
    food_surface = pygame.image.load(os.path.join(os.getcwd(), 'graphics', 'food.png'))
